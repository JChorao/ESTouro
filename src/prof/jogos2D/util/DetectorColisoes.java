...
/**
 * Classe utilit�ria que faz v�rios testes para verificar colis�es e outras
 * relacionadas com vetores
 * 
...
public class DetectorColisoes {
	 ...
	 * @return se bateram
	 */
	public static boolean intersetam(Point2D p1, double raio1, Point2D p2, double raio2) {
	...
	/**
	 * Para o segmento de reta, P1-P2, o m�todo retorna o ponto do segmento que
	 * esteja mais pr�ximo do ponto P3.
	 * 
	 ...
	 * Cada linha � representada pela sua equa��o linear. Linha 1 = a*x + c, Linha 2
	 * = b*x + d
	 * 
	...
	/**
	 * Retorna o ponto de intersec��o entre duas linhas.
	 * Cada linha é representada por dois pontos
	 * 
	...
	public static boolean intersectam(Rectangle r, Point c, int raio) {
		...
		// ok, sabemos que o rectangulo r est� dentro do rectangulo que delimita o
		// circulo
		...
		Point teste;
		// ver se � um ponto do lado esquerdo
		if (dx1 > 0) {
			if (dy1 > 0)
				teste = r.getLocation();
			else
